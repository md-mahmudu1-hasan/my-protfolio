            ...
            <div className="grid gap-8">
              <div className="space-y-4">
                ...
                <div className="prose prose-invert max-w-none text-gray-300 leading-relaxed">
                  ...
                  <p>
                    This project is built as a responsive, SEO-friendly web experience using modern JavaScript tools. It demonstrates clean UI design, strong backend architecture, fast loading behavior, and real-world business-ready functionality.
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="prose prose-invert max-w-none text-gray-300 leading-relaxed">
                  ...
                  <p>
                    It was created with a focus on performance, usability, and maintainability. The result is a polished web application that is ideal for startups, small businesses, and enterprise workflows.
                  </p>
                </div>
              </div>
            </div>
